...
class DesignsControllerTest < ActionController::TestCase
  ...
  test "should create design" do
    assert_difference('Design.count') do
      post :create, design: { description: @design.description, name: @design.name, user_id: @design.user_id, version: @design.version }
    end
  ...
  test "should update design" do
    patch :update, id: @design, design: { description: @design.description, name: @design.name, user_id: @design.user_id, version: @design.version }
    assert_redirected_to design_path(assigns(:design))
  end
